...
Singleton {
    ...
    property string generatedWallpaperCategoryPath: FileUtils.trimFileProtocol(`${Directories.state}/user/generated/wallpaper_category.txt`)
    property string pywalThemePath: FileUtils.trimFileProtocol(`${Directories.home}/.cache/wal/colors.json`)
